...
public class perfectRectangle {
    ...
    public boolean isRectangleCover(int[][] rectangles) {
        ...
        //Iterating to all the rectangles
        ...
        //make sure the size is 4 and all the coordinates has exists in the set
        if(points.size() != 4 || !points.contains(fullBottomLeft) || 
        !points.contains(fullTopLeft) || !points.contains(fullBottomRight) || 
        !points.contains(fullTopRight)) return false;

        //Computing full area of the rectangle
