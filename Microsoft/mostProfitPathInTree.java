...
public class mostProfitPathInTree {
    ...
    public void maxSum(int src, int time, ArrayList<Integer>[] graph, boolean[] visited, HashMap<Integer, Integer> map, int netincome[], 
